...
class Home {
        ...
        if (news) {
            ...
            blockNews.innerHTML = `
                <div class="news-header">
                    ...
                    <div class="news-content">
                        <div class="bbWrapper">
                            <p>No se puede contactar al servidor de noticias.</br>Por favor verifique su configuración.</p>
                        </div>
                    </div>`
            newsElement.appendChild(blockNews);
        }
    ...
    getdate(e) {
        ...
        let allMonth = ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Novembre', 'Diciembre']
